...
const data = [
    { id: 1, name: 'Electronic Car', text: 'All-electric vehicles, also referred to as battery electric vehicles (BEVs), have an electric motor instead of an internal combustion engine.The former is technically more accurate, even though some people search for the latter — and thats fine', picture: 'https://i.ibb.co/C0cnNKM/car-distribution.png' },
    { id: 2, name: 'Antique Car', text: 'A classic car is an older car, typically 25 years or older, though definitions vary. The common theme is of an older car of historical interest to be collectible and tend to be restored rather than scrapped.', picture: 'https://i.ibb.co/C0cnNKM/car-distribution.png' },
